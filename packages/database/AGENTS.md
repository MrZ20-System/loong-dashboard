...
Own LoongBoard's SQLite schema, migrations, constraints, and typed SQLite services.
...
- Add the smallest migration and typed-service tests for every schema change.
